...
$(function () { 
	...
	$(".table").on("click",".btnedit",function(){
		...
		$(".cardedit").show(500);
		$(".cardedit").load("<?=site_url("directpurchase/editinfo")?>",{id:rowid});
		return false;
	});
	...
	$(".table").on("click",".btndel",function(){
		...
		$.confirm({
			...
			buttons: {
				confirm: function () {
					window.location.href = "<?=site_url("directpurchase/remove/")?>"+rowid;
				},
				cancel: function () {
					//$.alert('Canceled!');
				}
    ...
    $(".table").on("click",".showentries",function(){
        ...
        setTimeout(function(){
            $("#entrysresult").load("<?=site_url('directpurchase/showentries/')?>"+id);
            $(".printlink").attr("href","<?=site_url('directpurchase/showentries/')?>"+id+"/print");
        }, 1000);
    });
          ...
          <div class="col-12">
            ...
            <!-- /.card -->
			 <div class="card cardnew card-warning" style="display:none;">
			  <?php $this->load->view("directpurchase_addnew") ?>
            </div>
