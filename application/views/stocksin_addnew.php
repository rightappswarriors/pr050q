...
$(function(){
    ...
    $("#refno").on("keyup keypress",function(){
        $("#invoiceor").val( $(this).val() );
    });
...
<form action="<?=site_url("stocksin/addnew")?>" method="POST" id="frmaddnew">
 <div class="card-header bg-gradient-warning border-0">
  ...
  <div class="col-md-6">
	...
	<div class="form-group">
      ...
      <div class="form-group">
	  <label><input type="checkbox" name="linktopayable" value="1" id="linktopayable" checked="checked"> Link to Payables?</label>
      <input type="text" placeholder="Invoice" class="form-control" name="invoiceor" id="invoiceor">
	</div>
