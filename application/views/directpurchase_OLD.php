...
$(function () { 
	...
	$('div.dropdownoptions').html('<form id="frmdropdown" method="POST" action="<?=site_url('directpurchase')?>"><select name="projectid" id="projectid" class="select2 form-control form-control-sm ml-2"><option value="" selected>ALL PROJECTS</option><?=$projectlist?></select></form>');
    ...
    $(".table").on("click",".showpayments",function(){
        ...
        setTimeout(function(){
            $("#paymentsresult").load("<?=site_url('directpurchase/showpayments/')?>"+payableid);       
        }, 1000);
    });
          ...
          <div class="col-12">
            ...
            <!-- /.card -->
			 <div class="card cardnew card-warning" style="display:none;">
			  ...
			  $this->load->view("directpurchase_addnew");
			  ?>
            </div>
